...
if (!function_exists('comparision')) {
     ...
     * @return $query
     * */
    function comparision($operator = '', $query = array(), $*** = '', $value = '') {
...
if (!function_exists('contains')) {
     ...
     * @return $query
     * */
    function contains($operator = '', $query = array(), $*** = '', $value = array()) {
...
if (!function_exists('sorting')) {
     ...
     * @return $query
     * */
    function sorting($operator = '', $query = array(), $*** = '') {
...
if (!function_exists('existence')) {
     ...
     * @return $query
     * */
    function existence($operator = '', $query = array(), $*** = '', $value = false) {
        if (!(!\Contentstack\Utility\isEmpty($***) && is_string($***)))
