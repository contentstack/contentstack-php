...
abstract class Contentstack {
     ...
     *  @param
     *      string|api_***        : Built.io Contentstack Stack API KEY.
     ...
     *  @return Stack
     * */
    public static function Stack($api_*** = '', $access_token = '', $environment = 'development') {
        return new Stack($api_***, $access_token, $environment);
    }
}